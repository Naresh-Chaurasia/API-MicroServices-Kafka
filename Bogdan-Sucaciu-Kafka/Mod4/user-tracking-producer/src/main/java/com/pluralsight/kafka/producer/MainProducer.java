...
public class MainProducer {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        props.put("bootstrap.servers", "ec2-52-77-223-37.ap-southeast-1.compute.amazonaws.com:9093,ec2-52-77-223-37.ap-southeast-1.compute.amazonaws.com:9094");
        props.put("key.serializer", "io.confluent.kafka.serializers.KafkaAvroSerializer");
        props.put("value.serializer", "io.confluent.kafka.serializers.KafkaAvroSerializer");
        //props.put("schema.registry.url", "http://localhost:8081");
        props.put("schema.registry.url", "http://ec2-52-77-223-37.ap-southeast-1.compute.amazonaws.com:8081");
