...
public class ProductsCommandController {
    ...
    public String createProducts(@Valid @RequestBody CreateProductRestModel createProductRestModel) throws InterruptedException {
        ...
        LOGGER.info("-------------------------ProductsCommandController/createProducts(@Valid @RequestBody CreateProductRestModel createProductRestModel)-------------------------");
        ...
        LOGGER.info("-------------------------ProductsCommandController/createProducts(@Valid @RequestBody CreateProductRestModel createProductRestModel)/calls commandGateway.sendAndWait(createProductCommand)-------------------------");
